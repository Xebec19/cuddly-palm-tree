...
exports.NX_INVOKED_BY_RUNNER = process.env.NX_INVOKED_BY_RUNNER === 'true';
...
exports.NUMBER_OF_AXIOS_RETRIES = exports.NX_CLOUD_DISTRIBUTED_EXECUTION ? 10 : 3;
...
function getMachineInfo(options) {
    ...
    if (options.canTrackAnalytics) {
        try {
            machineId = (0, node_machine_id_1.machineIdSync)();
        }
        catch (_a) { }
    }
    return {
