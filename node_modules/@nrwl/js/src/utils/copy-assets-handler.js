...
const defaultFileEventHandler = (events) => {
    ...
    events.forEach((event) => {
        if (event.type === 'create' || event.type === 'update') {
            ...
            logger_1.logger.error(`Unknown file event: ${event.type}`);
        }
    });
};
...
class CopyAssetsHandler {
    ...
    processAllAssetsOnce() {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            yield Promise.all(this.assetGlobs.map((ag) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                let pattern;
                if (typeof ag === 'string') {
                    pattern = ag;
                }
    ...
    watchAndProcessOnAssetChange() {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            const subscription = yield watcher.subscribe(this.projectDir, (err, events) => {
                var _a;
                if (err) {
                    logger_1.logger.error(`Watch error: ${(_a = err === null || err === void 0 ? void 0 : err.message) !== null && _a !== void 0 ? _a : 'Unknown'}`);
                }
                else {
