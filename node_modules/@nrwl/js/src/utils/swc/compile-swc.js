...
const cache_directory_1 = require("@nrwl/workspace/src/utilities/cache-directory");
...
function getSwcCmd(normalizedOptions, watch = false) {
...
function getTypeCheckOptions(normalizedOptions) {
    ...
    if (watch) {
        ...
        typeCheckOptions.cacheDir = cache_directory_1.cacheDir;
    }
...
function compileSwcWatch(context, normalizedOptions, postCompilationCallback) {
    return (0, tslib_1.__asyncGenerator)(this, arguments, function* compileSwcWatch_1() {
        ...
        return yield (0, tslib_1.__await)(yield (0, tslib_1.__await)(yield* (0, tslib_1.__asyncDelegator)((0, tslib_1.__asyncValues)((0, create_async_iteratable_1.createAsyncIterable)(({ next, done }) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            stdoutOnData = (data) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
