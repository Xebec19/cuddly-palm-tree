...
function processAssetsAndPackageJsonOnce(assetHandler, options, projectRoot) {
...
function swcExecutor(_options, context) {
    return (0, tslib_1.__asyncGenerator)(this, arguments, function* swcExecutor_1() {
        ...
        if (options.watch) {
            ...
            return yield (0, tslib_1.__await)(yield (0, tslib_1.__await)(yield* (0, tslib_1.__asyncDelegator)((0, tslib_1.__asyncValues)((0, compile_swc_1.compileSwcWatch)(context, options, processAssetsAndPackageJsonOnce(assetHandler, options, projectRoot))))));
        }
        else {
            return yield (0, tslib_1.__await)(yield yield (0, tslib_1.__await)((0, compile_swc_1.compileSwc)(context, options, processAssetsAndPackageJsonOnce(assetHandler, options, projectRoot))));
        }
    });
}
